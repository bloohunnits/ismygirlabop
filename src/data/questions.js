...
export const redFlags = [
  {
    ...
    icon: "🎭",
    context:
      'Classic BOP trickery bro. Women who throw around emotionally loaded words like "lust" are running a play. They use that language to get you emotionally invested in a way that benefits them, not you. Creates a fake deep connection. It\'s also textbook projection: women with a higher-than-average sex drive project that energy onto you through their word choices. If she\'s constantly framing things in terms of "lust," she\'s telling on herself.',
    yesExplanation:
  ...
  },
  {
    ...
    icon: "🚬",
    context:
      "Smoking is a risk-taking behavior and risk-taking behaviors cluster together bro. Smokers consistently report more sexual partners than non-smokers. It's tied to impulsivity, sensation-seeking, and prioritizing short-term gratification over long-term consequences. Smoking also carries traditionally masculine behavioral associations, and women who adopt more masculine behavior profiles tend to have higher partner counts. It's not the cigarette itself, it's what the habit signals about who she is.",
    yesExplanation:
...
export const greenFlags = [
  ...
  },
  {
    ...
    icon: "📝",
    context:
      "Real self-reflective practices like journaling, meditation, therapy for actual growth indicate high self-awareness, emotional intelligence, and intentionality. These traits lead to more deliberate decision-making and lower impulsivity. A woman who regularly examines her own thoughts and patterns is less likely to act on impulse and more intentional about who she lets in. Self-awareness is protective bro, people who understand their patterns are less likely to repeat destructive ones.",
    yesExplanation:
